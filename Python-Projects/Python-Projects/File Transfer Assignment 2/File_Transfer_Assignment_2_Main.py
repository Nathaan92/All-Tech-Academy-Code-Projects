...
import File_Transfer_Assignment_2_Func
...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.btn_abrowse = tk.Button(self.master,width=12,height=1,text='Source', command=lambda: File_Transfer_Assignment_2_Func.callbacka(self))
        self.btn_abrowse.grid(row=1,column=0,padx=(15,15),pady=(40,5),sticky=W)
        self.btn_bbrowse = tk.Button(self.master,width=12,height=1,text='Destination', command=lambda: File_Transfer_Assignment_2_Func.callbackb(self))
        self.btn_bbrowse.grid(row=2,column=0,padx=(15,15),pady=(5,5),sticky=W)
        self.btn_check = tk.Button(self.master,width=12,height=2,text='Update', command=lambda: File_Transfer_Assignment_2_Func.updato(self))
        ...
        self.btn_close = tk.Button(self.master,width=12,height=2,text='Close Program', command=lambda: File_Transfer_Assignment_2_Func.close(self))
