...
var mybug_icon = document.getElementById("bug_icon_btn");           /*defining global variables so we can use them in the disapear and reapear functions */
...
function disapear_icon() {
    
    mybug_icon.style.display = 'none';                      /* functin to make the bug report button disapear and disable when the right chevron is clicked*/
    mybug_icon_txt.style.display = 'none';
...
function reapear_icon() {                                   /*this function brings back the button when the left chevron is clicked.*/
    mybug_icon.style.display = 'inline'; 
    mybug_icon_txt.style.display = 'inline';
    mybug_icon_rightarrow.style.display = 'inline';
    mybug_icon_leftarrow.style.opacity = 'inline';
}
